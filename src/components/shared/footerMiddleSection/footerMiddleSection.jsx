...
export default function FooterMiddleSection({
    ...
    return (
        <div className="flex flex-col sm:w-3/5 mt-8 md:mt-10 lg:mt-0 gap-4 sm:gap-6 lg:gap-10">
            <h1 className="text-base sm:text-xl text-primaryColor font-medium">{heading}</h1>
            <div className="flex flex-col gap-1 text-grayColor text-sm sm:text-base text-nowrap mb-2 md:mb-0">
