...
const ServiceCard = ({
    ...
    return (
        <div className="bg-semiTransparent text-primaryColor  hover:bg-secondaryColor group w-96 sm:w-60 md:w-80 lg:w-64 xl:w-80 h-56 flex flex-col justify-center items-center hover:cursor-pointer">
            ...
            <img src={white_icon} alt="" height={60} width={60} className="hidden group-hover:flex group-hover:pb-2" />
            <p className="text-primaryColor group-hover:text-blackColor uppercase text-sm tracking-widest font-medium group-hover:font-medium pb-4">{desc}</p>
