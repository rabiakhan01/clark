...
const Intro = () => {
    return (
        <div className="pt-28 relative flex flex-col w-full md:h-[700px] h-[500px] bg-background-image bg-[length:420px_420px] md:bg-[length:700px_700px] sm:bg-[length:500px_500px] bg-no-repeat lg:bg-[right_-6.2rem_bottom_2rem] md:bg-[center_bottom_2rem] sm:bg-[center_bottom_0rem] bg-[center_bottom_2rem]" id="Home" >
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold flex flex-col lg:justify-start lg:items-start justify-center items-center text-center pt-36 sm:pt-40 md:pt-56 lg:pt-0">
