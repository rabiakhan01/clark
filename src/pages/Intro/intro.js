...
const Intro = () => {
    return(
        <div className="realtive flex flex-col w-full h-[700px] bg-background-image md:bg-[length:700px_700px] sm:bg-[length:500px_500px] bg-[length:400px_400px] bg-no-repeat lg:bg-[right_bottom_2rem] md:bg-[center_bottom_2rem] sm:bg-[center_bottom_14rem] bg-[center_bottom_20rem]">
