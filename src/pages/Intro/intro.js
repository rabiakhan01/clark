...
const Intro = () => {
    return (
        <div className="relative flex flex-col w-full md:h-[700px] h-[500px] bg-background-image md:bg-[length:700px_700px] sm:bg-[length:500px_500px] bg-[length:420px_420px] bg-no-repeat lg:bg-[right_-6.2rem_bottom_2rem] md:bg-[center_bottom_2rem] sm:bg-[center_bottom_0rem] bg-[center_bottom_2rem]">
