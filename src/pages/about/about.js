...
const About = () => {
    ...
    return (
        <div className="flex mt-20 h-full w-full">
            ...
            <div className="relative flex w-full  flex-col md:justify-start md:items-start justify-center items-center lg:w-3/6 md:w-2/5 text-primary lg:ml-0 mt-6 lg:left-0 md:left-8">
