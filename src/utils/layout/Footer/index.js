...
const Footer = () => {
    return (
        <footer className="flex flex-col justify-center items-center pt-20 md:pt-28">
            <div className="flex lg:flex-row flex-col gap-3">
                ...
                <div className="w-full flex flex-col gap-4 md:gap-6 lg:gap-10 mt-3 md:mt-10 lg:mt-0">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center text-sm sm:text-base  text-grayColor pt-4 pb-10">
